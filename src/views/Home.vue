<template>
	<el-row class="container">
		<el-col :span="24" class="header">
			<el-col @click.prevent="doTest" :span="10" class="logo" :class="collapsed?'logo-collapse-width':'logo-width'">
				{{collapsed?'':sysName}}
			</el-col>
			<el-col :span="10">
		...
		<el-col :span="24" class="main">
			<aside :class="collapsed?'menu-collapsed':'menu-expanded'">
				<!--导航菜单-->
				<el-menu  ref="menuExpand" :default-active="$route.path"  @open="handleopen" @close="handleclose" @select="handleselect"
					 unique-opened router v-if="!collapsed" :style="styleString">
					<el-menu-item index="/">
...
export default {
	...
	methods: {
		doMe(){
			...
			console.log(this.$refs.menuExpand.style);
		
			this.$refs.menuExpand.style.width ='230px';
